...
//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==
// QtResourcePropertyManager


class QtResourcePropertyManagerPrivate
{
    QtResourcePropertyManager *q_ptr;
    Q_DECLARE_PUBLIC(QtResourcePropertyManager)
public:
...
/*!
    \class QtScriptPropertyManager

    \brief The QtScriptPropertyManager provides and manages QString properties.
...
/*!
    Creates a manager with the given \a parent.
*/
QtResourcePropertyManager::QtResourcePropertyManager(QObject *parent)
    : QtAbstractPropertyManager(parent)
{
    d_ptr = new QtResourcePropertyManagerPrivate;
    d_ptr->q_ptr = this;
}
...
/*!
    Destroys this manager, and all the properties it has created.
*/
QtResourcePropertyManager::~QtResourcePropertyManager()
{
    clear();
    delete d_ptr;
}
...
/*!
    ...
    \sa setValue()
*/
QString QtResourcePropertyManager::value(const QtProperty *property) const
{
    return getValue<QString>(d_ptr->m_values, property);
}
...
/*!
    ...
    \sa setRegExp()
*/
QRegExp QtResourcePropertyManager::regExp(const QtProperty *property) const
{
    return getData<QRegExp>(d_ptr->m_values, &QtResourcePropertyManagerPrivate::Data::regExp, property, QRegExp());
}

/*!
    \reimp
*/
QString QtResourcePropertyManager::valueText(const QtProperty *property) const
{
    const QtResourcePropertyManagerPrivate::PropertyValueMap::const_iterator it = d_ptr->m_values.constFind(property);
    if (it == d_ptr->m_values.constEnd())
        return QString();
    return it.value().val;
}
...
/*!
    ...
    \sa value(), setRegExp(), valueChanged()
*/
void QtResourcePropertyManager::setValue(QtProperty *property, const QString &val)
{
    const QtResourcePropertyManagerPrivate::PropertyValueMap::iterator it = d_ptr->m_values.find(property);
    if (it == d_ptr->m_values.end())
        return;

    QtResourcePropertyManagerPrivate::Data data = it.value();
...
/*!
    ...
    \sa regExp(), setValue(), regExpChanged()
*/
void QtResourcePropertyManager::setRegExp(QtProperty *property, const QRegExp &regExp)
{
    const QtResourcePropertyManagerPrivate::PropertyValueMap::iterator it = d_ptr->m_values.find(property);
    if (it == d_ptr->m_values.end())
        return;
...
/*!
    \reimp
*/
void QtResourcePropertyManager::initializeProperty(QtProperty *property)
{
    d_ptr->m_values[property] = QtResourcePropertyManagerPrivate::Data();
}

/*!
    \reimp
*/
void QtResourcePropertyManager::uninitializeProperty(QtProperty *property)
{
    d_ptr->m_values.remove(property);
}
