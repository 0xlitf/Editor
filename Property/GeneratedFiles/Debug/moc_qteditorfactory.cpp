...
QT_MOC_LITERAL(6, 82, 17), // "slotCheckFinished"
QT_MOC_LITERAL(7, 100, 19) // "slotEditorDestroyed"

    },
    "QtLineEditFactory\0slotPropertyChanged\0"
    "\0QtProperty*\0slotRegExpChanged\0"
    "slotSetValue\0slotCheckFinished\0"
    "slotEditorDestroyed"
};
#undef QT_MOC_LITERAL
...
void QtLineEditFactory::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->d_func()->slotCheckFinished(); break;
        case 4: _t->d_func()->slotEditorDestroyed((*reinterpret_cast< QObject*(*)>(_a[1]))); break;
        default: ;
        }
    }
...
struct qt_meta_stringdata_QtResourceEditorFactory_t {
    QByteArrayData data[8];
    char stringdata0[121];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QtResourceEditorFactory_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QtResourceEditorFactory_t qt_meta_stringdata_QtResourceEditorFactory = {
    {
QT_MOC_LITERAL(0, 0, 23), // "QtResourceEditorFactory"
QT_MOC_LITERAL(1, 24, 17), // "toolButtonCreated"
QT_MOC_LITERAL(2, 42, 0), // ""
QT_MOC_LITERAL(3, 43, 12), // "QToolButton*"
QT_MOC_LITERAL(4, 56, 19), // "slotPropertyChanged"
QT_MOC_LITERAL(5, 76, 11), // "QtProperty*"
QT_MOC_LITERAL(6, 88, 19), // "slotEditorDestroyed"
QT_MOC_LITERAL(7, 108, 12) // "slotSetValue"

    },
    "QtResourceEditorFactory\0toolButtonCreated\0"
    "\0QToolButton*\0slotPropertyChanged\0"
    "QtProperty*\0slotEditorDestroyed\0"
    "slotSetValue"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_QtResourceEditorFactory[] = {
...
void QtResourceEditorFactory::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        QtResourceEditorFactory *_t = static_cast<QtResourceEditorFactory *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->toolButtonCreated((*reinterpret_cast< QToolButton*(*)>(_a[1]))); break;
        case 1: _t->d_func()->slotPropertyChanged((*reinterpret_cast< QtProperty*(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        case 2: _t->d_func()->slotEditorDestroyed((*reinterpret_cast< QObject*(*)>(_a[1]))); break;
        ...
        {
            typedef void (QtResourceEditorFactory::*_t)(QToolButton * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QtResourceEditorFactory::toolButtonCreated)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject QtResourceEditorFactory::staticMetaObject = {
    { &QtAbstractEditorFactory<QtResourcePropertyManager>::staticMetaObject, qt_meta_stringdata_QtResourceEditorFactory.data,
      qt_meta_data_QtResourceEditorFactory,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};


const QMetaObject *QtResourceEditorFactory::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *QtResourceEditorFactory::qt_metacast(const char *_clname)
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_QtResourceEditorFactory.stringdata0))
        return static_cast<void*>(const_cast< QtResourceEditorFactory*>(this));
    return QtAbstractEditorFactory<QtResourcePropertyManager>::qt_metacast(_clname);
}

int QtResourceEditorFactory::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = QtAbstractEditorFactory<QtResourcePropertyManager>::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 4)
...
// SIGNAL 0
void QtResourceEditorFactory::toolButtonCreated(QToolButton * _t1)
{
