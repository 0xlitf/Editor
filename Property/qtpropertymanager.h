...
class QT_QTPROPERTYBROWSER_EXPORT QtResourcePropertyManager : public QtAbstractPropertyManager
{
	Q_OBJECT
public:
	QtResourcePropertyManager(QObject *parent = 0);
...
protected:
	...
	virtual void uninitializeProperty(QtProperty *property);
private:
	QtResourcePropertyManagerPrivate *d_ptr;
	Q_DECLARE_PRIVATE(QtResourcePropertyManager)
		Q_DISABLE_COPY(QtResourcePropertyManager)
};
