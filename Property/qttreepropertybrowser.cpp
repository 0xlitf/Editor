...
public:
    ...
    void cloHMIEditor(QtProperty *property);
...
void QtPropertyEditorDelegate::cloHMIEditor(QtProperty *property)
{
...
void QtTreePropertyBrowserPrivate::disableItem(QTreeWidgetItem *item) const
{
    ...
    if (flags & Qt::ItemIsEnabled) {
        ...
        item->setFlags(flags);
        m_delegate->cloHMIEditor(m_itemToIndex[item]->property());
