/****************************************************************************
** Meta object code from reading C++ file 'librarytree.h'
**
...
#error "The header file 'librarytree.h' doesn't include <QObject>."
...
const QMetaObject LibraryTree::staticMetaObject = {
    { &QTreeWidget::staticMetaObject, qt_meta_stringdata_LibraryTree.data,
      qt_meta_data_LibraryTree,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *LibraryTree::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_LibraryTree.stringdata0))
        return static_cast<void*>(const_cast< LibraryTree*>(this));
