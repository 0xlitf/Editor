...
QT_MOC_LITERAL(1, 12, 15), // "RepeatBkgPixmap"
QT_MOC_LITERAL(2, 28, 16), // "BackgroundPixmap"
QT_MOC_LITERAL(3, 45, 11) // "CurrentPage"

    },
    "EditorScene\0RepeatBkgPixmap\0"
    "BackgroundPixmap\0CurrentPage"
};
...
void EditorScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< bool*>(_v) = _t->getRepeatBkgPixmap(); break;
        case 1: *reinterpret_cast< QString*>(_v) = _t->getBackgroundPixmap(); break;
        case 2: *reinterpret_cast< QString*>(_v) = _t->getCurrentPage(); break;
        default: break;
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setRepeatBkgPixmap(*reinterpret_cast< bool*>(_v)); break;
        case 1: _t->setBackgroundPixmap(*reinterpret_cast< QString*>(_v)); break;
        case 2: _t->setCurrentPage(*reinterpret_cast< QString*>(_v)); break;
        default: break;
        }
...
const QMetaObject EditorScene::staticMetaObject = {
    { &QGraphicsScene::staticMetaObject, qt_meta_stringdata_EditorScene.data,
      qt_meta_data_EditorScene,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
